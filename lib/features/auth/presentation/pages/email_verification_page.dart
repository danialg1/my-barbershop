...
class _EmailVerificationPageState extends State<EmailVerificationPage> {
  ...
  Future<void> _resendOTP() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://aleen-pseudoanaphylactic-bewailingly.ngrok-free.dev/barbershop_api/resend_otp.php'),
  ...
  Future<void> _verifyOTP() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://aleen-pseudoanaphylactic-bewailingly.ngrok-free.dev/barbershop_api/verify_otp.php'),
